  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-8 font-sans">
      <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-6">
        {lang === "ar" ? `سلة التسوق (${totalItems})` : `Your Shopping Cart (${totalItems})`}
      </h1>
      ...
      {cart.length === 0 ? (
        <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center max-w-lg mx-auto my-8 shadow-sm">
          ...
          <p className="text-sm text-slate-500 mb-6">
            {lang === "ar"
              ? "يبدو أنك لم تقم بإضافة أي مستلزمات طبية أو أدوية بعد."
              : "Looks like you haven't added any pharmacy essentials yet."}
          </p>
          <Link
            href="/"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {cart.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  title={lang === "ar" ? "إزالة العنصر" : "Remove item"}
                >
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm h-fit">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between text-slate-600">
                <span>{lang === "ar" ? "رسوم التوصيل السريع" : "Express Delivery Fee"}</span>
                <span className="font-semibold text-slate-900">
